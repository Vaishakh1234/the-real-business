...
const categoryViewAllClass =
  "inline-flex shrink-0 snap-start items-center gap-0.5 rounded-full border border-white bg-white px-2 py-1 text-[11px] font-semibold leading-tight text-brand-charcoal shadow-sm transition-[background-color,border-color,color,opacity] duration-200 hover:border-white hover:bg-neutral-100 hover:text-brand-charcoal focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-gold focus-visible:ring-offset-2 focus-visible:ring-offset-brand-charcoal xs:gap-1 xs:px-2.5 xs:py-1.5 xs:text-xs xs:leading-normal sm:snap-none sm:gap-1.5 sm:px-5 sm:py-2.5 sm:text-[15px]";
