...
import { PropertyDescriptionEditor } from "@/components/admin/properties/PropertyDescriptionEditor";
...
export function PropertyFormSimple({
  ...
  const form = useForm<PropertyFormValues>({
    ...
    defaultValues: { ...defaultValues, ...initialData, type: "sale" },
  });

  const title = form.watch("title");
  const structureKind = form.watch("structure_type") ?? "house";
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <Select
              value={structureKind}
              onValueChange={(v) =>
                form.setValue("structure_type", v as "house" | "plot")
              }
            >
              <SelectTrigger className="mt-1">
                <SelectValue />
          ...
          {structureKind === "plot" ? (
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input {...form.register("plot_number")} className="mt-1" />
              </div>
              <div>
                <Label>Plot dimensions</Label>
                <Input {...form.register("plot_dimensions")} className="mt-1" />
              </div>
            </div>
          ) : null}
          {structureKind === "house" ? (
