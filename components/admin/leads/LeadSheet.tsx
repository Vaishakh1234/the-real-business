        ...
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 z-10 p-4 sm:p-6 pb-[max(1.5rem,env(safe-area-inset-bottom))] bg-white/95 backdrop-blur-md border-t border-gray-100 flex gap-3 shrink-0 touch-manipulation">
            ...
            <Button
              type="submit"
              disabled={isPending}
              className="flex-[2] rounded-lg h-9 bg-gray-900 hover:bg-gray-800 text-white font-medium text-sm shadow-sm transition-all active:scale-[0.98] touch-manipulation"
            >
              {isPending ? (
