...
interface FilterSelectProps {
  ...
  "aria-label"?: string;
  /** When options are fetched remotely (e.g. categories), show a compact loader in the trigger. */
  isOptionsLoading?: boolean;
  optionsLoadingText?: string;
}
      ...
      <div className={cn("flex flex-col gap-1.5", className)}>
        ...
        <div
          className={cn(
            ...
            icon && "relative pl-10",
            triggerClassName,
            "flex cursor-wait items-center justify-start gap-2 opacity-90",
          )}
          aria-busy="true"
