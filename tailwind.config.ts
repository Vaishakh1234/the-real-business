...
const config: Config = {
  content: [
    ...
    "./app/**/*.{ts,tsx}",
    "./src/**/*.{ts,tsx}",
    // shared lib (sanitizers, etc.); description rich-text classes live in components/** for JIT visibility
    "./lib/**/*.{ts,tsx}",
  ],
  prefix: "",
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        ...
        /** Logo wordmark: Times New Roman when installed; else Tinos (see lib/fonts.ts) */
        "site-wordmark": [
          '"Times New Roman"',
          "Times",
      ...
      colors: {
        ...
        "brand-gold": {
          ...
          "muted-hover": "hsl(var(--brand-gold-muted-hover))",
        },
        "brand-blue": {
