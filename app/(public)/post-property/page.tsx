...
export default function PostPropertyPage() {
  return (
    ...
    >
      <div className="flex w-full max-w-screen-2xl flex-col items-stretch gap-12 lg:flex-row lg:items-center lg:gap-20 xl:gap-28">
        <div className="relative aspect-[4/3] w-full min-w-0 overflow-hidden lg:min-h-0 lg:flex-[1.42]">
          <Image
            src={ILLUSTRATION_SRC}
            alt=""
            fill
            className="object-cover object-center"
            sizes="(min-width: 1536px) 900px, (min-width: 1024px) 65vw, 100vw"
            priority
          />
        </div>
        <div className="flex min-w-0 w-full flex-col items-center gap-6 text-center sm:gap-8 lg:flex-1 lg:items-start lg:text-left">
          <p className="text-sm font-semibold uppercase tracking-[0.22em] text-brand-gold sm:text-base">
            Get listed
          </p>
          <h1 className="font-heading text-4xl font-bold leading-[1.08] text-foreground sm:text-5xl lg:text-5xl xl:text-6xl">
