...
export default function PrivacyPage() {
  return (
    <>
      {/* Hero */}
      <section className="overflow-hidden bg-brand-charcoal pt-20 pb-24">
      ...
      <section className="bg-white py-16 sm:py-24">
        <div className={publicContentFrameClass}>
          <div className="prose prose-neutral mx-auto max-w-3xl prose-headings:font-heading prose-headings:text-brand-charcoal prose-p:text-sm prose-p:text-muted-foreground prose-li:text-sm prose-li:text-muted-foreground">
            ...
            <p>
              ...
              fill out our contact form, request a valuation, or express
              interest in a property. We may also collect usage data, such as IP
              address, browser type, and pages visited, to improve our website
              and services.
            </p>
            ...
            <p>
              ...
              your experience, remember your preferences, and analyze traffic.
            ...
            <p>
              ...
              law. When data is no longer needed, we will securely delete or
              anonymize it.
            </p>
            ...
            <p>
              ...
              rights or ask questions about your data, please contact us using
              the details below.
            </p>
