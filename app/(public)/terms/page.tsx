...
export default function TermsPage() {
  return (
    <>
      {/* Hero */}
      <section className="overflow-hidden bg-black pt-20 pb-24">
      ...
      <section className="bg-white py-16 sm:py-24">
        <div className={publicContentFrameClass}>
          <div className="prose prose-neutral mx-auto max-w-3xl prose-headings:font-heading prose-headings:text-brand-charcoal prose-p:text-base prose-p:text-muted-foreground prose-li:text-base prose-li:text-muted-foreground">
            <h2 id="acceptance">1. Acceptance of Terms</h2>
            <p>
              By accessing or using the website and services of The Real
              Business (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;), you
            ...
            <p>
              Our website and services are provided for lawful purposes related
              to real estate search, inquiry, and engagement. You agree not to
              use our services to violate any applicable laws, infringe on the
              rights of others, or transmit harmful or offensive content. We
              reserve the right to suspend or terminate access at our
              discretion.
            </p>
            ...
            <p>
              ...
              We recommend that you verify all details and seek independent
              legal or financial advice as needed.
            </p>

            <h2 id="limitation-of-liability">5. Limitation of Liability</h2>
            <p>
              To the fullest extent permitted by law, The Real Business shall
